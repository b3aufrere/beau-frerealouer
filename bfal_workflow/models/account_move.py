...
class AccountMove(models.Model):
    ...
    division_id = fields.Many2one(
        'division', related='invoice_user_id.employee_id.branch_id.division_id', string='Division')
    # entreprise_id = fields.Many2one('entreprise', related='invoice_user_id.employee_id.entreprise_id', string='Entreprise')
    branch_id = fields.Many2one(
        'res.branch', related='invoice_user_id.employee_id.branch_id', string="Entreprise")
        ...
        for res in self:
            if res.tax_totals is not None:
                ...
                for data in vals.get('subtotals'):
                    ...
                    if data.get('name') == 'Untaxed Amount':
