...
{
    'name' : 'Sales Commission on Customer Payment with Product and Category Option',
    'version' : '4.1.2',
    'price' : 49.0,
    'summary' : 'This module enables option for compute commision based product and product category with customer payment option.',
    'depends' : ['sales_commission_external_user'],
    'currency': 'EUR',
    'category': 'Sales',
    'license': 'Other proprietary',
    'description': """
This module enables option for compute commision based product and product category with customer payment option.
...
Commission amount will be based on Net Revenue Model where it consider amounts without taxes. (This module does not support Gross Margin Model)
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/commission_external_user_extend/1034',#'https://youtu.be/X315BRmulV8',
